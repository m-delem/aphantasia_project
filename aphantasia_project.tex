...
en \LaTeX, dans l'Environnement de Développement Intégré
\href{https://posit.co/}{RStudio} , par l'intermédiaire du package
\texttt{knitr} (\protect\hyperlink{ref-knitr2014}{Xie, 2014},
...
\texttt{cluster,\ correlation,\ corrr,\ datasets,\ datawizard,\ dplyr,\ easystats,\ effectsize,\ equatiomatic,\ ez,\ factoextra,\ forcats,\ GGally,\ ggplot2,\ ggpubr,\ ggradar,\ ggraph,\ igraph,\ insight,\ librarian,\ lme4,\ lmerTest,\ MASS,\ Matrix,\ modelbased,\ purrr,\ rstatix,\ tidyr,\ et\ tidyverse}
