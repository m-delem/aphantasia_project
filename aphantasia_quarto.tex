...
considération de celui-ci comme un ``score'' pour les analyses (le temps
de réaction à la MRT est aussi utilisé dans la littérature, à d'autres
fins). Bien que la MRT soit en partie intégré dans le SRI (voir
...
\hypertarget{imagerie-et-profils-cognitifs}{%
\subsection*{Imagerie et profils
cognitifs}\label{imagerie-et-profils-cognitifs}}
\addcontentsline{toc}{subsection}{Imagerie et profils cognitifs}

\ldots{} Plein de choses à dire. Jeudi 16 février nous voilà !
