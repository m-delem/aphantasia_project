...
bibliography: simu_references.bib
csl: apa.csl
links-as-notes: true
link-citations: yes
lang: fr
langid: french
include-in-header: "simu_a_header.tex"
include-before-body: "simu_b_beforebody.tex"
keep-tex: true
---
<!-- shelf(quarto) -->
...
knitr::read_chunk('./zc_scripts/aphantasia_source_simu.R')
...
<!-- Introduction -->
```{r, child="simu_1_intro.Rmd"}
```

<!-- Méthode -->
```{r, child="simu_2_methode.Rmd"}
```

<!-- Résultats -->
```{r, child="simu_3_resultats.Rmd"}
```

<!-- Discussion --> 
```{r, child="simu_4_discussion.Rmd"}
```
