...
Le MAI [@schrawAssessingMetacognitiveAwareness1994] est une échelle d'auto-évaluation en 52 items
Chaque item est évalué sur une échelle de 5 points, allant de 1 à 5.
de type Likert à 5 points, allant de "1-toujours faux" à "5-toujours vrai".
le niveau d'accord des répondants avec les 52 items. Les scores élevés
indiquent un fort degré d'accord. Le MAI prend environ vingt
...
Nous avons construit un inventaire de 52 items pour mesurer la conscience métacognitive des adultes′. Les items ont été classés en huit sous-composantes subsumées sous deux catégories plus larges, la connaissance de la cognition et la régulation de la cognition.
### Tâches
