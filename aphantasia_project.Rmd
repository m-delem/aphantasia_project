...
output:
  pdf_document:
    ...
    df_print: kable
    includes:
      in_header: "za_header.tex"
      before_body: "zb_beforebody.tex"
lang: "fr"
langid: french
fontsize: 12pt
linestretch: 1.5
...
knitr::read_chunk('./zc_scripts/aphantasia_old_source.R')
...
Le p était de *p `r print_p(cor.test(data_scale$VVIQ,data_scale$OSIQ_O)$p.value)`*
